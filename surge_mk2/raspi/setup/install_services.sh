...
#    `temp[2]` を見ておくこと。速度 3.0 m/s ＝ 10.8 km/h は既定の GUI 設定（0.6 m/s）の
#    5倍で、ミニカーの大きさに対してはかなり速い。上げて走らせるときは周囲との距離に注意。
#
...
ARM="--allow-arm --max-speed 3.0 --max-steer 1.047"   # 1.047 rad ≒ 60°
MODE="arm 有効"
case "${1:-}" in
